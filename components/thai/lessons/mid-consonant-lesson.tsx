...
// Wraps the shared ConsonantTable in the explanatory scaffolding the bare
// table lacked, and carries the one-time Thai-script history primer (unit 2 is
// the first place a learner meets the alphabet). Mechanics prose is distilled
// from seed/thai/research/reading-thai-script.html §3 "Reading the consonants"
// and §4 "Consonants at the end of a syllable"; history is cited inside
// ThaiScriptHistory. Style matches the units 9-14 lessons (carded sections,
// muted prose over bg-surface).
    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-3 rounded-[var(--r-lg)] border border-border-base bg-surface p-5">
        <h2 className="text-sm font-semibold text-foreground">
          Why the letters come in classes
        </h2>
      ...
      <section className="flex flex-col gap-3 rounded-[var(--r-lg)] border border-border-base bg-surface p-5">
        <h2 className="text-sm font-semibold text-foreground">
          One letter, two jobs: start vs end
        </h2>
        <div className="flex flex-col gap-3 text-sm leading-relaxed text-foreground-muted">
          <p>
